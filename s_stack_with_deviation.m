...
% Compute stack and the deviation of the input traces from the stack. 
...
% where "a" is a scale factor chosen to make the difference small in the 
% least-squares sense.
%
% Written by: E. R.: April 3, 2006
% Last updated:
%
%
