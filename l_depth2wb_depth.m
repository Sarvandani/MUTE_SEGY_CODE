...
% the water depth and possibly the Kelly bushing are available as parameters
% ('wd' and 'ekb', respectively) of the well log. There must also be a field 
% 'parameter_info'. If these parameters were already in the LAS file they would
% have be automatically transferred to the log structure.
%
% Written by: E. R.: April 1, 2005
% Last updated:
%
