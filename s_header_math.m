...
% Written by E. R., October 15, 2000
% Last updated: September 5, 2002; handle seismic data without preexisting headers
%
%         seisout=s_header_math(seismic,action,expression,units,description)
% INPUT
...
%
% EXAMPLE
%               seisout=s_header_math(seismic,'add','cdp_x=25*cdp+1234','m','CDP X')
...
if any(ismember(words,'trace_no'))
   trace_no=1:size(seismic.traces,2);
end
